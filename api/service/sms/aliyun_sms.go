...
func NewAliYunSmsService(sysConfig *types.SystemConfig) (*AliYunSmsService, error) {
	...
	if sysConfig.SMS.Active == AliYun {
...
func (s *AliYunSmsService) UpdateConfig(config *types.SmsConfigAliyun) error {
