<template>
  <el-container class="captcha-box">
    <el-dialog
      ...
      style="width: 340px; --el-dialog-padding-primary: 5px 15px 15px 15px"
    >
      <template #header>
        <div class="text-center text-primary py-2 text-base">
          请完成安全验证
        </div>
      </template>
      <slide-captcha
...
<script setup>
  import CaptchaDot from '@/components/CaptchaDot.vue'
